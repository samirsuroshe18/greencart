...
<div class="p-6 space-y-6">
    ...
    @include('layouts.shared/admin-page-title', ['subtitle' => 'Coupons', 'title' => 'Edit Coupons'])
        ...
        <div class="p-5 border-t border-dashed border-default-200">
            <div class="grid md:grid-cols-2 gap-4 mb-6">
                <div class="space-y-1">
                    ...
                    <input type="text" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="couponTitle" value="Foodee" placeholder="Enter First Name">
                </div>

                <div class="space-y-1">
                    <label for="couponCode" class="text-sm font-medium text-default-900">Coupon Code</label>
                    <input type="text" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="couponCode" value="fd@986" placeholder="Enter Last Name">
                </div>
                ...
                <div class="space-y-1">
                    <label for="e-start-date" class="text-sm font-medium text-default-900">Start Date</label>
                    <input type="text" class="form-input w-full rounded py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="e-start-date">
                </div>

                <div class="space-y-1">
                    <label for="e-end-date" class="text-sm font-medium text-default-900">Start Date</label>
                    <input type="text" class="form-input w-full rounded py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="e-end-date">
                </div>

                <div class="space-y-1">
                    <label for="amountPercentage" class="text-sm font-medium text-default-900">Amount/Percentage</label>
                    <input type="text" class="block w-full rounded-md py-2.5 px-4 text-default-800 text-sm focus:ring-transparent border-default-200 dark:bg-default-50" id="amountPercentage" value="$20" placeholder="Add Roll No">
                </div>
