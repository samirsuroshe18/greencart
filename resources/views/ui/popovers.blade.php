...
<div class="p-6 space-y-6">
  ...
  @include('layouts.shared/admin-page-title', ['subtitle' => 'Base UI', 'title' => 'Popovers'])
  ...
  <div class="grid lg:grid-cols-2 gap-6">
    ...
    <div class="border border-default-200 rounded-lg bg-white dark:bg-default-50 h-fit">
      <div class="flex items-center justify-between py-4 px-5">
        <div class="">
          ...
          <p class="text-default-600 text-sm font-medium">Use <code class="text-primary">[--trigger:focus]</code> class for focus event.</p>
        </div>
      </div>
      <div class="p-5 border-t border-dashed border-default-200">
        <div class="flex flex-wrap gap-3">
    ...
    <div class="border border-default-200 rounded-lg bg-white dark:bg-default-50 h-fit">
      <div class="flex items-center justify-between py-4 px-5">
        <div class="">
          <h5 class="text-lg font-medium text-default-950 capitalize mb-1">Popover With Content</h5>
          <p class="text-default-600 text-sm font-medium">Example with content.</p>
        </div>
      </div>
      <div class="p-5 border-t border-dashed border-default-200">
        <div class="flex flex-wrap gap-3">
          <div class="hs-tooltip inline-block [--trigger:focus] [--placement:bottom-left]">
            <a class="hs-tooltip-toggle block text-center" href="javascript:;">
              ...
              <div class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible hidden opacity-0 transition-opacity absolute invisible z-[70] max-w-xs bg-white border border-default-200 text-start rounded-lg shadow-md dark:bg-default-50" role="tooltip">
