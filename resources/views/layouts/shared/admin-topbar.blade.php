    ...
    <div class="ms-auto flex items-center gap-4">
      ...
      <div class="flex">
        <div class="hs-dropdown relative inline-flex">
          ...
          <div class="hs-dropdown-menu duration mt-2 hidden min-w-[12rem] rounded-lg border border-default-200 bg-white p-2 opacity-0 shadow-md transition-[opacity,margin] hs-dropdown-open:opacity-100 dark:bg-default-50">
            <a class="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-800 transition-all hover:bg-default-100" href="{{ route('second', ['admin', 'wallet']) }}">
              <i class="ti ti-wallet text-base"></i>
              Wallet
            </a>
            <a class="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-default-800 transition-all hover:bg-default-100" href="{{ route('any', 'index') }}" target="_blank">
            ...
            <a class="flex items-center gap-x-3.5 rounded-md px-3 py-2 text-sm font-medium text-red-500 hover:bg-red-400/10" href="{{ route('second', ['auth', 'login']) }}">
