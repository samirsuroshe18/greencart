        ...
        <div class="grid gap-x-6 gap-y-10 xl:grid-cols-8">
          <div class="xl:col-span-2">
            ...
            <div class="mt-6 flex flex-wrap gap-2">
              <a href="{{ route('second' ,['admin', 'dashboard']) }}" target="_blank" class="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-2.5 text-center text-sm font-medium text-white shadow-sm transition-all duration-200 hover:bg-primary-600">
